...
import com.roughsea.controllers.MessageController;
...
@WithUserDetails(value = "Danila",userDetailsServiceBeanName = "userService")
...
public class MessageControllerTest {
    ...
    public void mainPageTest() throws Exception{
        this.mockMvc.perform(get("/main"))
                ...
                .andExpect(xpath("//div[@id=\"navbarSupportedContent\"]/div").string("Danila"));
    }
